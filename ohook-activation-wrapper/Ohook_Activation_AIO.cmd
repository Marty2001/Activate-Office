...
set set defname=DEFTEMP-%random%
...
set    "Blue="DarkBlue" "White""
set   "White="White" "Black""
set    "_Red="Black" "White""
set  "_White="Black" "White""
set  "_Green="DarkGreen" "White""
set "_Yellow="DarkYellow" "White""
)
...
if %_wmic% EQU 0 %psc% "$null=(([WMISEARCHER]'%sps%').GetInstances()).RefreshLicenseStatus()" %nul%
exit /b
...
::  Check potential script crash issue when user manually installs too many licenses for Office (length limit in variable)
...
echo "%error_code%" | findstr /i "0x80131040 0x800410 0x800440 0x80131501" %nul1% && set wmifailed=1& ::  https://learn.microsoft.com/en-us/windows/win32/wmisdk/wmi-error-constants
...
if %_wmic% EQU 0 set "chkedi=for /f "tokens=2 delims==" %%a in ('%psc% "SELECT LicenseFamily FROM %spp% WHERE ApplicationID=''55c92734-d682-4d71-983e-d6ec3f16059f'' AND LicenseDependsOn is NULL AND PartialProductKey IS NOT NULL' | %% {echo ('LicenseFamily='+$_)}" %nul6%')"
...
reg query "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Schedule\Tree\Microsoft\Windows\SoftwareProtectionPlatform\SvcRestartTask" %nul% || set taskinfo=Removed
...
14_36756cb8-8e69-4d11-9522-68899507cd6a_0057_VisioSIR_Prem[Pro,Std]Exception
14_98d4050e-9c98-49bf-9be1-85e12eb3ab13_6J3XK-DFKGK-X373V-QJHYM-V3%f%FC2_MAK___________VisioSIVL_Prem[Pro,Std]
14_db3bbc9c-ce52-41d1-a46f-1a1d68059119_001B_WordR_[HSWordR]
14_9cedef15-be37-4ff0-a08a-13a045540641_001B_WordVL
:: Office 2013
...
16_215c841d-ffc1-4f03-bd11-5b27b6ab64cc_NMNXPM-32XQC-Y7QJC-QGGBV-YY%f%K8F_OEM-ARM_______HomeStudentPlusARM2019Retail
