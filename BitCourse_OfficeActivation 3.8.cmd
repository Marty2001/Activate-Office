...
echo Go back to Main Menu, select Troubleshoot and run DISM Restore and SFC Scan options.
echo After that, restart system and try activation again.
echo:
set fixes=%fixes% %mas%in-place_repair_upgrade
...
title  Uninstall MS Office Activation %masver%
...
echo:
echo Uninstalling MS Office activation...
echo:
...
if defined _unerror (
call :dk_color %Red% "Failed to uninstall MS Office activation."
call :oh_checkapps
...
if defined fixes (
echo Follow ALL the ABOVE blue lines.   
echo Press [1] to Open Support Webpage  Press [0] to Ignore
choice /C:10 /N
